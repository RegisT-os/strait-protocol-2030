...
export const WAR_OPERATIONS: OperationDefinition[] = [
  ...
  },
  {
    ...
    durationDays: 7,
    startCost: { economy: -3 },
    upkeep: [{ intervalDays: 4, effects: { economy: -1 } }],
    risk: "medium-high",
    riskNotes: ["Retaliation roll"],
    success: {
      effects: { escalationLevel: 4, chest: 8, credibility: 8, allianceCohesion: 5 },
      notes: ["Opens the Sanctions Bite chain event"],
    },
    failure: {
      effects: { allianceCohesion: -8, economy: -3 },
  ...
  },
  {
    ...
    risk: "medium",
    success: {
      effects: { financialContagion: -22, economy: 12 },
      notes: ["Recession indicator recomputes lower next tick"],
    },
    failure: {
      effects: { chest: -3, financialContagion: -4, publicTrust: -5 },
